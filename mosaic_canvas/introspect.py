...
_NODE_INPUT_FIELDS: dict[str, list[InputField]] = {
    ...
    "stylizer": [
        ...
        InputField(name="negative_prompt", type="string", required=False,
                   description="What to avoid in the stylized output.",
                   group="advanced"),
    ...
    "translator": [
        ...
        InputField(name="source_language", type="choice", required=False, default="auto",
                   choices=["auto", "zh", "en", "ja", "ko", "fr", "de", "es", "ru", "ar", "pt", "it"],
                   description="Source language code. 'auto' for auto-detection."),
        InputField(name="target_language", type="choice", required=True, default="en",
                   choices=["zh", "en", "ja", "ko", "fr", "de", "es", "ru", "ar", "pt", "it"],
    ...
    "tts": [
        ...
        InputField(name="emotion", type="choice", required=False, default="neutral",
                   choices=["neutral", "cheerful", "sad", "excited", "angry", "gentle", "calm", "male", "young_male", "child"],
    ...
    "frame-extractor": [
        ...
        InputField(name="keyframe_threshold", type="float", required=False, default=10.0,
                   ...
                   group="advanced"),
        InputField(name="timestamps", type="string", required=False,
                   description='JSON array of timestamps for mode="timestamps", e.g. [0.5, 1.0, 2.5].',
                   group="advanced"),
    ],
    "ltx-video": [
        InputField(name="prompt", type="string", required=True,
    ...
    "field-mapper": [
        # No runtime input fields — mapping and drop_fields are constructor
        # parameters auto-extracted from __init__.  The user sets "mapping"
        # (singular) as a constructor param, e.g. {"reply": "prompt"}.
    ],
    "type-converter": [
