    ...
    const _templates = [
        ...
        },
        {
            ...
            nodes: [
                ...
                {
                    id: 'n3', type: 'field-mapper', label: '',
                    params: { mapping: '{"subtitle": "data"}', drop_fields: '[]' },
                    input_params: {},
                    ...pos(2, 0),
                },
                {
        ...
        // ── 11_cross_domain_pipeline.py ──
        {
            ...
            edges: [
                ...
                { id: 'e3', source: 'n3', target: 'n4' },
                { id: 'e4', source: 'n4', target: 'n5' },
                { id: 'e5', source: 'n5', target: 'n_mid' },
                { id: 'e6', source: 'n_mid', target: 'n6' },
            ],
        ...
        // ── 文本分类导出模板 ──
        {
            ...
            nodes: [
                ...
                {
                    id: 'n2', type: 'field-mapper', label: '',
                    params: { mapping: '{"predicted_label": "data"}', drop_fields: '[]' },
                    input_params: {},
                    ...pos(1, 0),
                },
                {
        ...
        // ── JSON 提取正/负面提示词 → 文生图 ──
        {
            ...
            nodes: [
                ...
                },
                {
                    ...
                    params: { source_field: 'reply' },
                    input_params: {},
                    ...pos(1, 0),
                },
                {
                    id: 'n3', type: 'field-mapper', label: '',
                    params: { mapping: '{"data.positive_prompt": "prompt", "data.negative_prompt": "negative_prompt"}', drop_fields: '["messages"]' },
                    input_params: {},
                    ...pos(2, 0),
                },
                {
            ...
            nodes: [
                {
                    ...
                    params: { source_field: 'text' },
                    input_params: {},
                    ...pos(0, 0),
                },
                {
                    id: 'n2', type: 'field-mapper', label: '',
                    params: { mapping: '{"data.positive_prompt": "prompt", "data.negative_prompt": "negative_prompt"}', drop_fields: '[]' },
                    input_params: {},
                    ...pos(1, 0),
                },
            ],
