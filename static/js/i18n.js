...
const I18n = (() => {
    ...
    const _dict = {
        en: {
            ...
            'prompts.custom_hint': 'Add your own JSON file to data/prompt-library.json to extend the library.',
        ...
        zh: {
            ...
            'prompts.custom_hint': '将您自己的 JSON 文件放入 data/prompt-library.json 即可扩展提示词库。',
