...
const I18n = (() => {
    ...
    const _dict = {
        en: {
            ...
            'prop.parameters': 'Constructor Parameters',
            'prop.no_params': 'This node has no configurable parameters.',
            'prop.input_fields': 'Input Fields (Runtime)',
            'prop.input_fields_hint': 'These values are passed to the node at execution time via MosaicData.',
        ...
        zh: {
            ...
            'prop.parameters': '构造参数',
            'prop.no_params': '此节点没有可配置的参数。',
            'prop.input_fields': '输入字段（运行时）',
            'prop.input_fields_hint': '这些值在执行时通过 MosaicData 传递给节点。',
